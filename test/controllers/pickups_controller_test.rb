...
class PickupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pickup" do
    assert_difference('Pickup.count') do
      post pickups_url, params: { pickup: { departure_time: @pickup.departure_time, destination: @pickup.destination, source: @pickup.source } }
    end
  ...
  test "should update pickup" do
    patch pickup_url(@pickup), params: { pickup: { departure_time: @pickup.departure_time, destination: @pickup.destination, source: @pickup.source } }
